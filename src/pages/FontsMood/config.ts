...
export const mapWordData = {
  [Theme.rage]: {
    ...
    [RageFonts.roboto]: {
      ...
      Какое слово мной ни${nbsp}набери, я${nbsp}ничего не${nbsp}буду выражать. Поэтому оставьте меня для Андроида, а${nbsp}для${nbsp}выразительности выберите что${hyphen}то${nbsp}другое`,
    },
  },
  [Theme.anorexy]: {
    [AnorexyFonts.roboto]: {
